...
class TestStatusCommand:
    """Tests for TestStatusCommand."""

    def test_status_no_lock(self, tmp_path: Path) -> None:
        """Test Status no lock."""
        result = runner.invoke(
            app,
            [
                "--lockfile",
                str(tmp_path / "dbport.lock"),
                "status",
            ],
        )
    ...
    def test_status_with_model(self, tmp_path: Path) -> None:
        """Test Status with model."""
...
""",
    ...
    def test_status_with_schema(self, tmp_path: Path) -> None:
        """Test Status with schema."""
        lock = tmp_path / "dbport.lock"
        _create_lock(
            lock,
            """
...
""",
    ...
    def test_status_empty_models(self, tmp_path: Path) -> None:
        """Test Status empty models."""
        lock = tmp_path / "dbport.lock"
    ...
    def test_status_with_inputs_and_rows(self, tmp_path: Path) -> None:
        """Test Status with inputs and rows."""
        lock = tmp_path / "dbport.lock"
        _create_lock(
            lock,
            """
...
""",
    ...
    def test_status_no_schema(self, tmp_path: Path) -> None:
        """Test Status no schema."""
        lock = tmp_path / "dbport.lock"
        _create_lock(
            lock,
            """
...
class TestStatusHistory:
    """Tests for TestStatusHistory."""

    def test_history_flag(self, tmp_path: Path) -> None:
        """Test History flag."""
        lock = tmp_path / "dbport.lock"
        _create_lock(
            lock,
...
class TestStatusInputs:
    """Tests for TestStatusInputs."""

    def test_inputs_flag(self, tmp_path: Path) -> None:
        """Test Inputs flag."""
    ...
    def test_inputs_without_timestamp(self, tmp_path: Path) -> None:
    ...
    def test_inputs_flag_no_inputs(self, tmp_path: Path) -> None:
...
class TestStatusRaw:
    """Tests for TestStatusRaw."""

    def test_raw_flag(self, tmp_path: Path) -> None:
        """Test Raw flag."""
        repo = _setup_repo(tmp_path)
        _create_lock(repo / "dbport.lock", _RICH_LOCK)
        result = runner.invoke(
    ...
    def test_raw_no_lock(self, tmp_path: Path) -> None:
        """Test Raw no lock."""
        repo = _setup_repo(tmp_path)
        result = runner.invoke(
            app,
    ...
    def test_raw_json(self, tmp_path: Path) -> None:
        """Test Raw json."""
        repo = _setup_repo(tmp_path)
        _create_lock(repo / "dbport.lock", _RICH_LOCK)
        result = runner.invoke(
...
class TestStatusJson:
    """Tests for TestStatusJson."""

    def test_json_with_inputs_history(self, tmp_path: Path) -> None:
        """Test Json with inputs history."""
        repo = _setup_repo(tmp_path)
        _create_lock(repo / "dbport.lock", _RICH_LOCK)
        result = runner.invoke(
            app,
    ...
    def test_json_without_inputs_history(self, tmp_path: Path) -> None:
    ...
    def test_json_no_lock(self, tmp_path: Path) -> None:
        """Test Json no lock."""
        repo = _setup_repo(tmp_path)
        result = runner.invoke(
            app,
    ...
    def test_json_no_models(self, tmp_path: Path) -> None:
        """Test Json no models."""
        repo = _setup_repo(tmp_path)
    ...
    def test_json_with_inputs_versions(self, tmp_path: Path) -> None:
        """Test Json with inputs versions."""
        lock = tmp_path / "dbport.lock"
        _create_lock(
            lock,
            """
...
""",
    ...
    def test_status_respects_model_flag(self, tmp_path: Path) -> None:
        """Test Status respects model flag."""
        repo = _setup_repo(tmp_path)
        _create_lock(repo / "dbport.lock", _RICH_LOCK)
        result = runner.invoke(
            app,
...
class TestStatusRawJsonNoLock:
    ...
    def test_raw_json_no_lock(self, tmp_path: Path) -> None:
        """Test Raw json no lock."""
        repo = _setup_repo(tmp_path)
        result = runner.invoke(
            app,
            [
...
class TestStatusJsonModelResolution:
    ...
    def test_json_model_flag_resolves(self, tmp_path: Path) -> None:
    ...
    def test_json_fallback_to_first_model(self, tmp_path: Path) -> None:
...
class TestStatusCombined:
    """Tests for TestStatusCombined."""

    def test_combined_inputs_history(self, tmp_path: Path) -> None:
        """Test Combined inputs history."""
        repo = _setup_repo(tmp_path)
        _create_lock(repo / "dbport.lock", _RICH_LOCK)
        result = runner.invoke(
            app,
    ...
    def test_history_no_versions(self, tmp_path: Path) -> None:
    ...
    def test_default_summary(self, tmp_path: Path) -> None:
